...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        self.net.createConvLayer('conv1_1', pycnnl.IntVector([1, 3, 224, 224]), 64, 3, 1, 1, 1)
        self.net.createReLuLayer('relu1_1')
        self.net.createConvLayer('conv1_2', pycnnl.IntVector([1, 64, 224, 224]), 64, 3, 1, 1, 1)
        self.net.createReLuLayer('relu1_2')
        self.net.createPoolingLayer('pool1', pycnnl.IntVector([1, 64, 224, 224]), 2, 2)

        self.net.createConvLayer('conv2_1', pycnnl.IntVector([1, 64, 112, 112]), 128, 3, 1, 1, 1)
        self.net.createReLuLayer('relu2_1')
        self.net.createConvLayer('conv2_2', pycnnl.IntVector([1, 128, 112, 112]), 128, 3, 1, 1, 1)
        self.net.createReLuLayer('relu2_2')
        self.net.createPoolingLayer('pool2', pycnnl.IntVector([1, 128, 112, 112]), 2, 2)

        self.net.createConvLayer('conv3_1', pycnnl.IntVector([1, 128, 56, 56]), 256, 3, 1, 1, 1)
        self.net.createReLuLayer('relu3_1')
        self.net.createConvLayer('conv3_2', pycnnl.IntVector([1, 256, 56, 56]), 256, 3, 1, 1, 1)
        self.net.createReLuLayer('relu3_2')
        self.net.createConvLayer('conv3_3', pycnnl.IntVector([1, 256, 56, 56]), 256, 3, 1, 1, 1)
        self.net.createReLuLayer('relu3_3')
        self.net.createConvLayer('conv3_4', pycnnl.IntVector([1, 256, 56, 56]), 256, 3, 1, 1, 1)
        self.net.createReLuLayer('relu3_4')
        self.net.createPoolingLayer('pool3', pycnnl.IntVector([1, 256, 56, 56]), 2, 2)

        self.net.createConvLayer('conv4_1', pycnnl.IntVector([1, 256, 28, 28]), 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu4_1')
        self.net.createConvLayer('conv4_2', pycnnl.IntVector([1, 512, 28, 28]), 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu4_2')
        self.net.createConvLayer('conv4_3', pycnnl.IntVector([1, 512, 28, 28]), 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu4_3')
        self.net.createConvLayer('conv4_4', pycnnl.IntVector([1, 512, 28, 28]), 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu4_4')
        self.net.createPoolingLayer('pool4', pycnnl.IntVector([1, 512, 28, 28]), 2, 2)

        self.net.createConvLayer('conv5_1', pycnnl.IntVector([1, 512, 14, 14]), 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu5_1')
        self.net.createConvLayer('conv5_2', pycnnl.IntVector([1, 512, 14, 14]), 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu5_2')
        self.net.createConvLayer('conv5_3', pycnnl.IntVector([1, 512, 14, 14]), 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu5_3')
        self.net.createConvLayer('conv5_4', pycnnl.IntVector([1, 512, 14, 14]), 512, 3, 1, 1, 1)
        self.net.createReLuLayer('relu5_4')
        self.net.createPoolingLayer('pool5', pycnnl.IntVector([1, 512, 14, 14]), 2, 2)

        self.net.createMlpLayer('fc6', pycnnl.IntVector([1, 1, 1, 25088]), pycnnl.IntVector([1, 1, 25088, 4096]), pycnnl.IntVector([1, 1, 1, 4096]))
        self.net.createReLuLayer('relu6')
        self.net.createMlpLayer('fc7', pycnnl.IntVector([1, 1, 1, 4096]), pycnnl.IntVector([1, 1, 4096, 4096]), pycnnl.IntVector([1, 1, 1, 4096]))
        self.net.createReLuLayer('relu7')

        self.net.createMlpLayer('fc8', pycnnl.IntVector([1, 1, 1, 4096]), pycnnl.IntVector([1, 1, 4096, 1000]), pycnnl.IntVector([1, 1, 1, 1000]))
        self.net.createSoftmaxLayer('softmax', pycnnl.IntVector([1, 1, 1000]), 1)
