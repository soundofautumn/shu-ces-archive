...
if __name__ == '__main__':
    ...
    for i, image in enumerate(data_group):
        ...
        concatenated = torch.cat((image_c, image_g), dim=3)  # 左右拼接，维度3是宽度方向
        save_path = f'./out/cpu/result_{i + 1}.jpg'
